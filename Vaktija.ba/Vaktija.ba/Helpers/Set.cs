...
namespace Vaktija.ba.Helpers
{
    class Set
    {
        ...
        public static void PageHeader(Page mainPage, Grid grid, string title, string subtitle, string toPage)
        {
            grid.Children.Clear();
            ...
            Viewbox subVB = new Viewbox { HorizontalAlignment = Windows.UI.Xaml.HorizontalAlignment.Left, MaxHeight = 66, };
