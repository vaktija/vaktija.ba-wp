...
namespace Vaktija.ba.Pages
{
    public sealed partial class Settings : Page
    {
        ...
        private string Daj_Ime_Zvuka_Notifikacije(string x, bool star = false)
        {
            ...
            {
                x = x.Replace("ms-appx:///Assets/Sounds/", "").Replace(".wav", "").Replace(".mp3", "").Trim();
            }
        ...
        private void stdPodneCB_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            Set.Group_Notifications(2, 0, true, 2);
            Postavi_Stranicu();
        }
        ...
        {
            await Windows.System.Launcher.LaunchUriAsync(new Uri("mailto:windows@vaktija.ba?subject=Vaktija_za_Windows10"));
        }
